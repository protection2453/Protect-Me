...
<body>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="comm_updateAction.jsp?bbsID=<%= bbs.getBbsID() %>&commID=<%= comm.getCommID() %>">
				<table class="table table-striped">
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="댓글제목" name="commTitle" maxlength="50" value="<%= comm.getCommTitle() != null ? comm.getCommTitle() : null %>"></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="댓글내용" name="commContent" maxlength="2048" style="height: 350px;"><%= comm.getCommContent() != null ? comm.getCommContent() : null %></textarea></td>
						</tr>					
					</tbody>
				</table>
