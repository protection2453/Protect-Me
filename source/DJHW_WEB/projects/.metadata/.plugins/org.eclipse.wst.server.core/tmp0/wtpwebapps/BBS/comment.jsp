		...
		<div class="row">
			<form method="post" action="commentAction.jsp?bbsID=<%= bbs.getBbsID() %>">
				<table class="table table-striped">
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="댓글제목" name="commTitle" maxlength="50"></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="댓글내용" name="commContent" maxlength="2048" style="height: 350px;"></textarea></td>
						</tr>
					</tbody>
				</table>
